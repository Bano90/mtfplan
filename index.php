<?php
 class Plan{
     ...
     function post($app,$params)
     {
         ...
         $mapper->eventtype=$data->eventtype; //esettípus
         $mapper->description=$data->description; // részletes leírás
         if($data->eventtype=="újrateszt"){
         ...
         else if($data->eventtype=="kísérlet"){
     ...
     function put($app,$params)
     {
         ...
         else if($plan->eventtype=="kísérlet"){
